...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-32482b34.mjs').then((m) => m.default || m)
  },
  {
    name: "recipe-id",
    path: "/recipe/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-eb13bbbc.mjs').then((m) => m.default || m)
  },
  {
    name: "recipeApi-idApi",
    path: "/recipeApi/:idApi()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_idApi_-0945199a.mjs').then((m) => m.default || m)
  },
  {
    name: "recipeApi",
    path: "/recipeApi",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ffad706b.mjs').then((m) => m.default || m)
  },
  {
    name: "results-SearchParam",
    path: "/results/:SearchParam()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_SearchParam_-27923253.mjs').then((m) => m.default || m)
  },
  {
    name: "results",
    path: "/results",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-25eb4b11.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-a84e154f.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-38dc18e3.mjs').then((r) => r.default || r));
